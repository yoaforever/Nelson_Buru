...
if ( isset($_FILES["file"]["type"]) )
{
  ...
  $destination_directory = "uploads/image_profile/";
       ...
       ) && in_array($file_extension, $validextensions))
  {
    if ( $_FILES["file"]["size"] < ($max_size) )
    {
      ...
      else
      {
        ...
        {
          echo "<div class=\"alert alert-danger\" role=\"alert\">Error: File <strong>" . $_FILES["file"]["name"] . "</strong> already exists. You should rename the photo and try again</div>";
        }
        else
        {
...
//          echo "<p>Temp file: <strong>" . $_FILES["file"]["tmp_name"] . "</strong></p>";
          echo "<p>You should save the changes of your profile to be updated in BD</strong></p>";
          echo "</div>";
        }
      }
    }
