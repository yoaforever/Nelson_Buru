...
var myTransatypes = angular.module('myTransatypes', ['ngRoute', 'ngResource']);


        myTransatypes.controller('TransatypesCtrl', ['$scope', 'TransactionTypes','$route', function ($scope, TransactionTypes, $route) {
         ...
         myTransatypes.controller('TransatypesDashbCtrl', ['$scope', 'TransactionTypes','$route', function ($scope, TransactionTypes, $route) {
               $scope.transactions_type_id = $scope.txn.transactions_types_id;
                ...
                getTransactionTypesDashb.success(function (response) {
                    $scope.transactions_types = response;
                    $scope.TransactionTypesDashb = $scope.transactions_types[0];
