(function () {
    ...
    function modalDialog($modal, $templateCache) {
        var service = {
            ...
            alertErrorDialog: alertErrorDialog
        };
        ...
        $templateCache.put('modalDialogWarning.tpl.html',
          '<div>' +
          '    <div class="modal-header">' +
          '        <button type="button" class="close" data-dismiss="modal" aria-hidden="true" data-ng-click="cancel()">&times;</button>' +
          ...
          '        <p><span class="alert-danger">{{message}}</span></p>' +
          '    </div>' +
          '    <div class="modal-footer">' +         
          '        <button class="btn btn-danger" data-ng-click="ok()">{{cancelText}}</button>' +
          '    </div>' +
          '</div>');
        ...
        function alertErrorDialog(title, msg, cancelText)
        {
            var modalOptions = {
                templateUrl: 'modalDialogWarning.tpl.html',
                controller: ModalInstance,
                keyboard: true,
                resolve: {
                    options: function () {
