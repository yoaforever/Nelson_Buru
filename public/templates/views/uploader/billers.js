       ...
       // CALLBACKS
        ...
        uploader.onAfterAddingFile = function(fileItem,item) {
            ...
            r.onload = function(e) {
                ...
                var dbheader = ["Company_Name","Email_Address","Phone_Number","TIN","DBA","FAX","Address","City","Zip_Code","State","Country","Debit_Account_Number","Debit_Routing_Number","Debit_Bank_Name","Credit_Account_Number","Credit_Routing_Number","Credit_Bank_Name","Company_ID"];
        ...
        uploader.onSuccessItem = function(fileItem, response, status, headers) {
        	...
        	if(response.answer == "Error")
    		{
        		...
        		if($scope.failedcolumns != "")
	        		$scope.failedcolumns += "<br/><br/>"+"Following Billers in "+ fileItem.file.name +" are failed to import <br/>"+response.failedrows;
	        	else
	        		$scope.failedcolumns += "Following Billers in "+ fileItem.file.name +" are failed to import <br/>"+response.failedrows;
