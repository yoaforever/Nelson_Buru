       ...
       // CALLBACKS
        ...
        uploader.onAfterAddingFile = function(fileItem,item) {
            ...
            r.onload = function(e) {
                ...
                var dbheader = ["legal_name","email","phone","tin","dba","fax","company_id"];
        ...
        uploader.onSuccessItem = function(fileItem, response, status, headers) {
        	...
        	if(response.answer == "Error")
    		{
        		...
        		if($scope.failedcolumns != "")
	        		$scope.failedcolumns += "<br/><br/>"+"Following Payors in "+ fileItem.file.name +" are failed to import <br/>"+response.failedrows;
	        	else
	        		$scope.failedcolumns += "Following Payors in "+ fileItem.file.name +" are failed to import <br/>"+response.failedrows;
