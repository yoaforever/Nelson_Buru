var tasksService = angular.module('mytasks', ['ngRoute', 'ngResource']);

tasksService.controller('taskCtrl', function ($scope,$rootScope,logger,$route,$routeParams,Session, tasksService,Session) {
	var vm = this;
		var keyCodes = {
        backspace: 8,
        tab: 9,
...
tasksService.factory("tasksService", function ($http) {
    ...
    return{
        all: function () {
            var request = $http({method: 'GET', url: 'api/tasks'});
            return request;
        },
	create: function (data) {
            var request = $http({method: 'GET', url: 'api/tasks/create', params: data});
            return request;
        },
	update: function (id, data) {
        var request = $http.put('api/tasks/update/'+id,data);
            return request;
        },       
        get: function (id) {
