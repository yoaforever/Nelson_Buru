<?php namespace App\libraries\Nachalib;
 ...
 private $fileId;
   ...
   // Takes money from someone else account and puts it in yours
    ...
    public function generateFile($filemodifier=false){
        ...
        //$this->fileContents = "FILE HEADER".PHP_EOL.$this->fileHeader.PHP_EOL."BATCH HEADER".PHP_EOL.$this->batchHeader.PHP_EOL."DETAILED RECORDS".PHP_EOL.$this->batchLines.PHP_EOL."BATCH FOOTER".PHP_EOL.$this->batchFooter.PHP_EOL."FILE FOOTER".PHP_EOL.$this->fileFooter;
        $this->fileContents = $this->fileHeader.PHP_EOL.$this->batchHeader.PHP_EOL.$this->batchLines.PHP_EOL.$this->batchFooter.PHP_EOL.$this->fileFooter;
        return true;
    }
